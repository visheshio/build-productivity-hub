...
export function AuthPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDark ? 'bg-gray-950' : 'bg-gradient-to-br from-violet-50 via-white to-indigo-50'} transition-colors duration-300`}>
      {/* Top bar */}
      <div className={`flex items-center justify-between px-6 py-4 ${isDark ? 'border-gray-800' : 'border-slate-200'} border-b`}>
      ...
      {/* Quote ticker */}
      <div className="bg-gradient-to-r from-violet-600 to-indigo-600 py-2.5 px-4 text-center overflow-hidden">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`w-full rounded-2xl shadow-2xl p-8 ${isDark ? 'bg-gray-900 border border-gray-800' : 'bg-white border border-slate-100'}`}>
            {/* Tab switcher */}
            ...
            <div className={`mt-6 pt-6 border-t ${isDark ? 'border-gray-800' : 'border-slate-100'}`}>
              <p className={`text-xs text-center mb-3 ${isDark ? 'text-gray-600' : 'text-slate-400'}`}>
                — Quick demo —
              </p>
              <button
                type="button"
